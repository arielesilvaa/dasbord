...
import { Home, Package, PanelBottom, Users, ShoppingBag, Settings2, LogOut } from 'lucide-react'
...
export function Sidebar(){
    return(
        <div className="flex w-full flex-col bg-muted/40">
                ...
                <nav className='flex flex-col items-center gap-4 px-2 py-5'>
                    <TooltipProvider>
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent side="right">Prodtos</TooltipContent>
                        </Tooltip>
            ...
            <div className="sm:hidden flex flex-col sm:gap-04 sm:py-4 sm:pl-14">
